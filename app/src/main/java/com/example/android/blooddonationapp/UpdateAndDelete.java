        ...
        databaseDonor.child(idDelete).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(UpdateAndDelete.this, R.string.DonorUpdatedSuccessfully, Toast.LENGTH_SHORT).show();

                } else {
                    // TODO: handle the case where the data does not yet exist
                    Toast.makeText(UpdateAndDelete.this, R.string.idNOTfound, Toast.LENGTH_SHORT).show();
                }
            }
