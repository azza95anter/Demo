package com.example.android.blooddonationapp.widget;
...
public class WidgetUpdateService extends IntentService {
     ...
     */
    public static final String ACTION_WIDGET_DONORS_UPDATE = "com.example.android.blooddonationapp.action.update_widget";
    public static final String EXTRA_WIDGET_DONORS = "com.example.android.blooddonationapp.extra.widget_donors";

    public WidgetUpdateService() {
        super("com.example.android.blooddonationapp.widget.WidgetUpdateService");
    }
