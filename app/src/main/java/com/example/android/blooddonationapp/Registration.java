...
public class Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDoalog = new ProgressDialog(Registration.this);
    ...
    private void registerUser() {
        ...
        if (password.length() < 6) {
            ...
            progressDoalog = ProgressDialog.show(Registration.this, "",getString(R.string.plzWait), true);
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(Registration.this, R.string.userRegSuccessfully, Toast.LENGTH_SHORT).show();
                                ...
                                if (task.getException() instanceof FirebaseAuthActionCodeException) {
                                    Toast.makeText(Registration.this, R.string.userAlreadyIn, Toast.LENGTH_SHORT).show();
