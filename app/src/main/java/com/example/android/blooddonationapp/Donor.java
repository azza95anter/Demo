...
import com.example.android.blooddonationapp.Model.DataDonor;
   ...
   ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Donor.this, MapsActivity.class);
        ...
        databaseDonor.child(idDelete).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(Donor.this, R.string.updatedSuccessfully, Toast.LENGTH_SHORT).show();

                } else {
                    // TODO: handle the case where the data does not yet exist
                    Toast.makeText(Donor.this, R.string.idNOTfound, Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void AddDonor() {
        ...
        if (DonorId.length() < 6) {
            ...
            Toast.makeText(Donor.this, R.string.DonorAdded, Toast.LENGTH_SHORT).show();
        ...
        databaseDonor.child(donorId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(Donor.this, R.string.DeletedSuccessfully, Toast.LENGTH_SHORT).show();
